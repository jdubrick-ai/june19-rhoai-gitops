...
# Application
An application built from https://github.com/jdubrick-ai/june19-rhoai will be stored in [quay.io/jdubrick-ai/june19-rhoai](https://quay.io/jdubrick-ai/june19-rhoai) and deployed through GitOps. This application is accessible on port **8501**.